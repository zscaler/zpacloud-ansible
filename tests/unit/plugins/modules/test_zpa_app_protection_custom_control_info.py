...
class TestZPAAppProtectionCustomControlInfoModule(ModuleTestCase):
    ...
    def test_get_all_controls(self, mock_client, mocker):
        ...
        from ansible_collections.zscaler.zpacloud.plugins.modules import zpa_app_protection_custom_control_info
    ...
    def test_get_control_by_id(self, mock_client):
        mock_client.app_protection.get_custom_control.return_value = (MockBox(self.SAMPLE_CONTROLS[0]), None, None)
