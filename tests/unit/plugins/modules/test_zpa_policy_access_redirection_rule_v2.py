...
class TestZPAPolicyAccessRedirectionRuleV2Module(ModuleTestCase):
    ...
    def test_create_rule(self, mock_client, mocker):
        ...
        mock_client.policies.add_redirection_rule_v2.return_value = (
        ...
        from ansible_collections.zscaler.zpacloud.plugins.modules import (
            zpa_policy_access_redirection_rule_v2,
        )
    ...
    def test_update_rule(self, mock_client, mocker):
        ...
        mock_client.policies.update_redirection_rule_v2.return_value = (
            MockBox(self.SAMPLE_RULE),
            None,
            None,
        )
    ...
    def test_delete_rule_error(self, mock_client, mocker):
        ...
        set_module_args(
            provider=DEFAULT_PROVIDER, name="Test_Redirection_Rule_V2", state="absent"
        )
        from ansible_collections.zscaler.zpacloud.plugins.modules import (
            zpa_policy_access_redirection_rule_v2,
        )
