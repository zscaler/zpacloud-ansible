...
class TestZPAPolicyAccessRedirectionRuleV2Module(ModuleTestCase):
    ...
    def test_update_rule(self, mock_client, mocker):
        ...
        mocker.patch(
            ...
            "zpa_policy_access_redirection_rule_v2.collect_all_items",
        ...
        set_module_args(
            provider=DEFAULT_PROVIDER, state="present", name="Test_Redirection_Rule_V2",
            description="Test Redirection Rule V2", action="REDIRECT_DEFAULT",
        )
        from ansible_collections.zscaler.zpacloud.plugins.modules import zpa_policy_access_redirection_rule_v2
        with pytest.raises(AnsibleExitJson) as result:
            zpa_policy_access_redirection_rule_v2.main()
    ...
    def test_get_rule_by_id(self, mock_client, mocker):
        ...
        set_module_args(
            ...
            name="Test_Redirection_Rule_V2", state="absent",
        )
        from ansible_collections.zscaler.zpacloud.plugins.modules import zpa_policy_access_redirection_rule_v2
        with pytest.raises(AnsibleExitJson) as result:
            zpa_policy_access_redirection_rule_v2.main()
    ...
    def test_check_mode_create(self, mock_client, mocker):
        ...
        set_module_args(
            provider=DEFAULT_PROVIDER, name="New", action="REDIRECT_DEFAULT",
    ...
    def test_check_mode_delete(self, mock_client, mocker):
        ...
        set_module_args(
            provider=DEFAULT_PROVIDER, name="Test_Redirection_Rule_V2",
