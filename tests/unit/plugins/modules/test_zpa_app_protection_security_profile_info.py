...
class TestZPAAppProtectionSecurityProfileInfoModule(ModuleTestCase):
    ...
    def test_get_all_profiles(self, mock_client, mocker):
        ...
        from ansible_collections.zscaler.zpacloud.plugins.modules import zpa_app_protection_security_profile_info
    ...
    def test_get_profile_by_id(self, mock_client):
        mock_client.app_protection.get_profile.return_value = (MockBox(self.SAMPLE_PROFILES[0]), None, None)
