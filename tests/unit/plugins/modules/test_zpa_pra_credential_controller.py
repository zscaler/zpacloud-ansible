...
class TestZPAPRACredentialControllerModule(ModuleTestCase):
    ...
    def test_create_credential(self, mock_client, mocker):
        ...
        mock_client.pra_credential.add_credential.return_value = (
            mock_created,
            None,
            None,
        )
    ...
    def test_update_credential(self, mock_client, mocker):
        ...
        mock_client.pra_credential.update_credential.return_value = (
            mock_updated,
            None,
            None,
        )
    ...
    def test_get_credential_by_id(self, mock_client, mocker):
        ...
        mock_client.pra_credential.get_credential.return_value = (
            MockBox(self.SAMPLE_CRED),
            None,
            None,
        )
        mock_client.pra_credential.delete_credential.return_value = (None, None, None)
        set_module_args(
            provider=DEFAULT_PROVIDER, id="8530", name="credential01", state="absent"
        )
        from ansible_collections.zscaler.zpacloud.plugins.modules import (
            zpa_pra_credential_controller,
        )
    ...
    def test_delete_credential_error(self, mock_client, mocker):
        ...
        mock_client.pra_credential.delete_credential.return_value = (
            None,
            None,
            "Delete failed",
        )
