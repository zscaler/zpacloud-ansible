...
class TestConvertPortsAdvanced:
    ...
    def test_convert_ports_dict_format(self):
        from ansible_collections.zscaler.zpacloud.plugins.module_utils.utils import convert_ports
        input_ports = [{"from": "80", "to": "80"}, {"from": "443", "to": "443"}]
...
class TestValidateISO3166Alpha2:
    ...
    def test_valid_country_code_us(self):
        from ansible_collections.zscaler.zpacloud.plugins.module_utils.utils import validate_iso3166_alpha2
...
class TestValidateTimeoutIntervals:
    ...
    def test_valid_interval_human_readable(self):
        from ansible_collections.zscaler.zpacloud.plugins.module_utils.utils import validate_timeout_intervals
...
class TestNormalizeAppAdvanced:
    ...
    def test_normalize_with_none_values(self):
        from ansible_collections.zscaler.zpacloud.plugins.module_utils.utils import normalize_app
...
class TestCollectAllItemsAdvanced:
    ...
    def test_paginated_response_single_page(self):
        from ansible_collections.zscaler.zpacloud.plugins.module_utils.utils import collect_all_items
...
class TestNormalizePortProcessingAdvanced:
    ...
    def test_with_tcp_port_range(self):
        ...
        input_app = {
            "name": "test",
            "tcp_port_range": [{"from": "80", "to": "80"}, {"from": "443", "to": "443"}]
        }
        result = normalize_port_processing(input_app)
...
class TestConvertPortsListAdvanced:
    ...
    def test_convert_ports_list_none(self):
        from ansible_collections.zscaler.zpacloud.plugins.module_utils.utils import convert_ports_list
...
class TestValidateTcpQuickAck:
    ...
    def test_all_true(self):
        from ansible_collections.zscaler.zpacloud.plugins.module_utils.utils import validate_tcp_quick_ack
...
class TestIsNumberAdvanced:
    ...
    def test_is_number_float(self):
        from ansible_collections.zscaler.zpacloud.plugins.module_utils.utils import is_number
...
class TestSecondsToHumanReadableAdvanced:
    ...
    def test_zero_seconds(self):
        from ansible_collections.zscaler.zpacloud.plugins.module_utils.utils import seconds_to_human_readable
...
class TestValidateLatitudeLongitudeAdvanced:
    ...
    def test_validate_latitude_boundary_low(self):
        from ansible_collections.zscaler.zpacloud.plugins.module_utils.utils import validate_latitude
    ...
    def test_validate_longitude_boundary_low(self):
        from ansible_collections.zscaler.zpacloud.plugins.module_utils.utils import validate_longitude
