...
class TestZPAServiceEdgeControllerInfoModule(ModuleTestCase):
    """Unit tests for zpa_service_edge_controller_info module."""

    SAMPLE_SERVICE_EDGE = {
        "id": "216199618143441990",
        "name": "Test_Service_Edge",
    ...
    SAMPLE_SERVICE_EDGE_2 = {
        "id": "216199618143441991",
        "name": "Test_Service_Edge_2",
        "description": "Test Service Edge 2",
        "enabled": True,
        "latitude": "40.7128",
        "longitude": "-74.0060",
        "platform": "linux",
    ...
    def mock_client(self, mocker):
        with patch(
            "ansible_collections.zscaler.zpacloud.plugins.modules.zpa_service_edge_controller_info.ZPAClientHelper"
        ) as mock_class:
    ...
    def test_service_edge_not_found_by_name(self, mock_client, mocker):
        """Test error when service edge not found by name"""
        mock_edges = [MockBox(self.SAMPLE_SERVICE_EDGE)]
        mocker.patch(
            "ansible_collections.zscaler.zpacloud.plugins.modules.zpa_service_edge_controller_info.collect_all_items",
            return_value=(mock_edges, None),
        )
